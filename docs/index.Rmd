...
### Análise para todos os motores e para o conjunto de motores "críticos"
...
cat(paste("Resultados compilados",sep = "\n"))
...
cat(paste("Resultados dos motores críticos, RUL <= 50 ciclos",sep = "\n"))
for (metodo in methods) {
